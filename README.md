...
> 以下数据来自 `PerformanceTest` 实测（Windows 11, JDK 21, 4C8G），空任务空转场景，反映框架本身开销。
...
```bash
javac -d out -sourcepath "src/main/java;src/test/java" \
      src/test/java/io/github/magic5689/seqconsumer/PerformanceTest.java
java -cp out io.github.magic5689.seqconsumer.PerformanceTest
```
